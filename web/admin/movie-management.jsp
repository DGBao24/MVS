                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    Add New Movie</div>
                                                <form action="movie" method="POST" id="addMovieForm" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="file" class="form-control" name="MoviePoster" id="MoviePoster" 
                                            ...
                                            <table class="table table-bordered" id="movieTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="../images/<%= movie.getMoviePoster() %>" 
                                                                 alt="<%= movie.getMovieName() %>" class="img-thumbnail" style="max-width: 100px;">
                                                        </td>
